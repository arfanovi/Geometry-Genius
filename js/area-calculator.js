...
//     setTextField('Parallelogram-area',area);
...
//     const minorRadius = getInputValue('ellipse-major-radius')

//     const area = 3.14 * majorRadius * minorRadius;
//     const areaTwoDecimal = area.toFixed(2)
//     setTextField('ellipse-area', area, areaTwoDecimal)
// }
...
function calculatePentagonArea(){
    ...
    const apothem = getInputValue('apothem-pentagon')
